async function login() {
  ...
  if (!loginValue || !passwordValue) {
    errorMessage.innerHTML =
      '<div class="alert alert-danger">Login and password are required.</div>';
    return;
  }
...
async function reg() {
  ...
  try {
    ...
    if (response.ok) {
      ...
      errorMessage.innerHTML =
        '<div class="alert alert-success">Регистрация прошла успешно! Вы можете войти в свой аккаунт.</div>';
    ...
    errorMessage.innerHTML =
      '<div class="alert alert-danger">Произошла ошибка при регистрации. Попробуйте позже.</div>';
  }
}
