...
async function loadEventDetails() {
    ...
    try {
        ...
        if (response.ok) {
            ...
            document.getElementById('event_description').innerText = event.description;
            document.getElementById('event_date').innerText = formatDate(event.event_date);
...
document.getElementById('addEventToUser').addEventListener('click', function (e) {
    e.preventDefault();
    const urlParams = new URLSearchParams(window.location.search);
